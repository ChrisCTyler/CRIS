...
$file = 'pdo_insert_list_items.php';
...
try {
     ...
     $sql = "REPLACE ListItem (RecordID, ListItemID, HistoryDate, SyncID, CreationDate, CreatedByID, ListType, ItemValue, IsDisplayed, SerialisedObject) ";
     $sql .= "VALUES (:recordid, :listitemid, :historydate, :syncid, :creationdate, :createbyid, :listtype, :itemvalue, :isdisplayed, :serialisedobject)";
     ...
     foreach($data as $label=>$value){
          switch ($label) {
              ...
              default:
                  ...
                  $sth->bindValue(':listitemid', $value["ListItemID"], PDO::PARAM_STR);
                  ...
                  $sth->bindValue(':listtype', $value["ListType"], PDO::PARAM_STR);
                  $sth->bindValue(':itemvalue', $value["ItemValue"], PDO::PARAM_STR);
                  $sth->bindValue(':isdisplayed', $value["IsDisplayed"], PDO::PARAM_INT);
