...
$file = 'pdo_insert_system_errors.php';
...
try {
    ...
    $sql = "REPLACE SystemError (RecordID, SyncID, CreationDate, CreatedByID, SerialisedObject) ";
    $sql .= "VALUES (:recordid, :syncid, :creationdate, :createdbyid, :serialisedobject)";
