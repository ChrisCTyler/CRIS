...
try {
    ...
    $JSONData = $_POST['JSONData'];
     ...
     $sql = "REPLACE Follow (SyncID, Cancelled, ClientID, UserID, StartDate) VALUES (:syncid, :cancelled, :clientid, :userid, :startdate) ";
     ...
     foreach($data as $label=>$value){
          switch ($label) {
              ...
              default:
                  ...
                  $sth->bindValue(':startdate', $value["StartDate"], PDO::PARAM_INT);
                  if (!$sth->execute()){
                      throw new Exception($sth->errorInfo()[2]);
                  }
          }
